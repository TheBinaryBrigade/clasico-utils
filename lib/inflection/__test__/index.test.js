...
(0, globals_1.describe)("inflection", () => {
    (0, globals_1.describe)("test pluralize plurals", () => {
        (0, globals_1.expect)(__1.default.pluralize("plurals")).toBe("plurals");
        (0, globals_1.expect)(__1.default.pluralize("Plurals")).toBe("Plurals");
    });
    (0, globals_1.describe)("pluralize empty string", () => {
        (0, globals_1.expect)(__1.default.pluralize("")).toBe("");
    });
    (0, globals_1.describe)("test unaacountability", () => {
    ...
    (0, globals_1.describe)("test uncountable word is not greedy", () => {
    ...
    (0, globals_1.describe)("test camelize with lower downcases the first letter", () => {
        (0, globals_1.expect)(__1.default.camelize("Capital", false)).toBe("capital");
    });
    (0, globals_1.describe)("test camelize with underscores", () => {
