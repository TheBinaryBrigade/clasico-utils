...
if (globals_1.test.each === undefined) {
    ...
    globals_1.test.each = testEachPolyfill;
}
...
(0, globals_1.describe)("inflection", () => {
    ...
    (0, globals_1.describe)("parameterize", () => {
        globals_1.test.each(STRING_TO_PARAMETERIZED)("parameterized string of %p should be equal to %p", (someString, parameterizedString) => {
            (0, globals_1.expect)(__1.default.parameterize(someString)).toBe(parameterizedString);
        });
        globals_1.test.each(STRING_TO_PARAMETERIZED_AND_NORMALIZED)("parameterized and normalized string of %p should be equal to %p", (someString, parameterizedString) => {
            (0, globals_1.expect)(__1.default.parameterize(someString)).toBe(parameterizedString);
        });
        globals_1.test.each(STRING_TO_PARAMETERIZE_WITH_UNDERSCORE)("parameterized string of %p with '_' separator should be equal to %p", (someString, parameterizedString) => {
            (0, globals_1.expect)(__1.default.parameterize(someString, "_")).toBe(parameterizedString);
        });
        globals_1.test.each(STRING_TO_PARAMETERIZED)("parameterized string of %p with '__sep__' separator should be equal to %p", (someString, parameterizedString) => {
            let ps = parameterizedString;
            while (ps.includes("-")) {
                ps = ps.replace("-", "__sep__");
            }
            (0, globals_1.expect)(__1.default.parameterize(someString, "__sep__")).toBe(ps);
        });
        globals_1.test.each(STRING_TO_PARAMETERIZE_WITH_NO_SEPARATOR)("parameterized string of %p with no separator should be equal to %p", (someString, parameterizedString) => {
            (0, globals_1.expect)(__1.default.parameterize(someString, "")).toBe(parameterizedString);
        });
    });
    ...
    (0, globals_1.describe)("ordinal", () => {
        globals_1.test.each(ORDINAL_NUMBERS)("ordinalized number %p should be equal to %p", (num, ordinalized) => {
            (0, globals_1.expect)(num + __1.default.ordinal(num)).toBe(ordinalized);
        });
    });
    (0, globals_1.describe)("ordinalize", () => {
        globals_1.test.each(ORDINAL_NUMBERS)("ordinalized number %p should be equal to %p", (num, ordinalized) => {
            (0, globals_1.expect)(__1.default.ordinalize(num)).toBe(ordinalized);
        });
    });
