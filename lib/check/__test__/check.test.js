...
(0, globals_1.describe)("check", () => {
    (0, globals_1.describe)("isError", () => {
        ...
        examples.forEach(([input, output]) => {
            (0, globals_1.test)(`(${JSON.stringify(input)}: ${typeof input}, errorLike=true)`, () => {
                const result = __1.default.isError(input, true);
    ...
    Object.entries(tests).forEach(([fnName, { examples, returnTypes }]) => {
        (0, globals_1.describe)(fnName, () => {
            ...
            examples.forEach(({ input, output }) => {
                (0, globals_1.test)(`(${JSON.stringify(input, (key, value) => {
                    ...
                    (0, globals_1.expect)(returnTypes.includes(typeof result)).toBe(true);
                    (0, globals_1.expect)(result).toBe(output);
                });
            });
        });
