...
const camelize = (str: string, uppercaseFirstLetter = true): string => {
  const camelCase = dasherize(str)
    .replace(/-/, " ")
 ...
 * > 'st'
 */
const ordinal = (num: string | number): string => {
 ...
 * > '-1021st'
 */
const ordinalize = (num: string | number) => {
  return num.toString() + ordinal(num);
};

const parameterize = (str: string, separator = "-") => {
